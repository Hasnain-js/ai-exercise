	...
	<main>
		<section class="relative z-10 pt-32 lg:pt-36 xl:pt-40 pb-20">
			...
			<div class="text-center px-4">
				<h1 class="font-extrabold text-heading-2 text-white mb-5">Sign in</h1>
				...
				<div class="wow fadeInUp rounded-3xl bg-white/[0.05]">
					<div class="flex">
						<div class="hidden lg:block w-full lg:w-1/2">
							<div class="relative py-20 pl-16 pr-20">
								<div
									class="absolute top-0 right-0 w-[1px] h-full bg-gradient-to-b from-white/0 via-white/20 to-white/0"
								></div>
								<h2
									class="max-w-[292px] font-bold text-white text-heading-4 mb-10"
								>
						...
						<div class="w-full lg:w-1/2">
							<div class="py-8 sm:py-20 pl-8 sm:pl-20 pr-8 sm:pr-20">
								<form>
									<!-- <button
										class="w-full flex items-center justify-center gap-3 p-3 font-medium text-white rounded-lg border border-white/[0.12] ease-in duration-300 hover:border-purple"
									>
										<svg
											width="23"
											height="22"
									...
									<button
										class="mt-4 w-full flex items-center justify-center gap-3 p-3 font-medium text-white rounded-lg border border-white/[0.12] ease-in duration-300 hover:border-purple"
									>
										<svg
											width="22"
											height="22"
									...
									<span
										class="relative block font-medium text-sm text-center my-7"
									>
										<span
											class="block absolute left-0 top-1/2 h-[1px] w-20 bg-white/[0.12]"
										></span>
										<span
											class="block absolute right-0 top-1/2 h-[1px] w-20 bg-white/[0.12]"
										></span>
									...
									<div class="mb-4 relative">
										...
										<input
											...
											class="w-full border border-white/[0.12] bg-transparent rounded-lg focus:border-purple pl-14 pr-4 py-3 font-medium outline-none focus-visible:shadow-none"
										/>
									</div>
									...
									<div class="flex items-center justify-between mb-7">
										<div x-data="{ checkboxToggle: false }">
											...
											>
												<div class="relative">
													...
													/>
													<div
														:class="checkboxToggle && 'border-purple bg-purple'"
										...
										<a
											href="/"
											class="font-medium text-sm text-purple"
											>Forgot Password?</a
										>
									</div>
									<button
