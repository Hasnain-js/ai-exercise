	...
	<main>
		<section class="relative z-10 pt-32 lg:pt-36 xl:pt-40 pb-20">
			...
			<div class="text-center px-4">
				<h1 class="font-extrabold text-heading-2 text-white mb-5">Sign up</h1>
						...
						<div class="w-full lg:w-1/2">
							<div class="py-8 sm:py-20 pl-8 sm:pl-20 pr-8 sm:pr-20">
								<form>
									...
									>
										<span
											class="block absolute left-0 top-1/2 h-[1px] w-22.5 bg-white/[0.12]"
										></span>
										<span
											class="block absolute right-0 top-1/2 h-[1px] w-22.5 bg-white/[0.12]"
										></span>
